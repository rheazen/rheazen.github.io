...
<div class="row trm-scroll-animation" >
    <div class="col-lg-12">
        ...
        <div class="trm-card trm-active-el">
            大家好，我是<strong>银耳</strong>，很高兴您能在浩瀚如烟的互联网世界里发现这个博客，更感谢您能够饶有兴致地浏览这个页面。建立这个 Blog 是出于兴趣爱好，我将在此分会分享一些学习笔记，可能还会分享少许图片、视频以及其他有趣东西的链接。
        </div>
    </div>
</div>
...
<div class="row trm-scroll-animation">
    <div class="col-lg-12">
        ...
        <div class="trm-card trm-active-el">
            <ul class="trm-list">
                <li>程序：<a href="https://vitepress.dev/" style="font-weight:700" target="_blank" rel="nofollow">Vitepress</a></li>
                <li>主题：<a href="https://github.com/MaLuns/vitepress-theme-async" style="font-weight:700" target="_blank" rel="nofollow">Vitepress-theme-async</a></li>
                <li>托管：<a href="https://vercel.com" style="font-weight:700" target="_blank" rel="nofollow">Github Pages</a></li>
            </ul>
        </div>
    </div>
</div>
